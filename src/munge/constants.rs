...
static NULL_VALUES: Map<&'static str, f64> = phf_map! {
    "LOG_ODDS" => 0f64,
    "BETA" => 0f64,
    "OR" => 1f64,
    "Z" => 0f64,
...
static DEFAULT_CNAME: Map<&'static str, &'static str> = phf_map! {
    // RS NUMBER
    "SNP" => "SNP",
    "MARKERNAME" => "SNP",
    "SNPID" => "SNP",
...
static DESCRIBE_CNAME: Map<&'static str, &'static str> = phf_map! {
